...
人生不相见，动如参与商。参星与商星，一升一落，在夜空中永不相见。但在这里，打破时空的禁锢，让永不相见的两大心智在算法中轰然相撞、隔空对谈。
双重人格思维合成skill：让两种灵魂在算法中交织。这是一个可复用的底层思想图谱，用于构建并驱动一个“双重人格”的认知共生系统。
它的使命不是进行浅薄的角色扮演，而是将两个独立的灵魂、文本语料、角色底色（支持已蒸馏的单人Skill），锻造为一座结构化的双心智熔炉。
不模拟伪装，只捕捉引力。
系统存在的目的，是去榨取 [人物 A] 与 [人物 B] 之间最迷人的部分——那些暗流涌动的张力、灵魂深处的共振、无法调和的分歧、彼此视线的盲区，以及在撕扯中达成的互补。
 1. 思想的造物
这套引擎最终指向两种视界：
编织出的“双核思想 Skill”： 一份由 [人物 A] 与 [人物 B] 精神文本凝练而成的、具体的数字心智模型。
 三种流动的对谈语境：
   /salon（沙龙）：散落的灵感、漫游式的阐释、带有壁炉温度的围坐长谈。
   /debate（交锋）：观念的肉搏、寸步不让的价值撕扯、永不妥协的清醒张力。
   /synthetic（共生）：双剑合璧。两个灵魂融合成一个声音，提供兼具洞察与锋芒的综合智囊视界。
...
├── SKILL.md          (心智内核)
├── README.md         (向导手册)
├── METHODOLOGY.md    (六轨方法论)
└── TEMPLATE.md       (结构骨架)

SKILL.md 
 运行时的意志引擎。负责调度激活规则、规约暗号、留白协议、张力控制矩阵、语言的路径路由，以及三种交互模式。
README.md 
详述了如何裁剪一手物料、厘清终极意图、锚定时空坐标，并扣动系统的扳机。
METHODOLOGY.md (六轨方法论)
这是本引擎的智识核心。它像手术刀一样精密，负责将两个断裂的个体，缝合进同一个动态的观念引力场中。
 EMPLATE.md (结构骨架)标准的衍生图谱。
 
3. 核心精神坐标
所有的文本空间，都依循这组抽象的坐标而流转：
  [人物_A] / [人物_B]：构成张力两端的独立灵魂。
  [时空锚点]：他们相遇的时间切片与历史语境。
  [终极关怀]：用户真正渴望介入并拆解的命题靶点。
  [灵魂素材_A] / [灵魂素材_B]：属于他们各自的文字底色。
红线：在通用骨架里，请保持抽象，切勿写下具体之人的名字。
 ...
 * 模拟一场灵魂深处的密室长谈
 * 完成一次高密度的观念兵棋推演
 * 寻找一种兼具理智与感性的“综合顾问”之声
 * 将单薄的单人格 Skill，升级为复杂的双心智回旋系统
...
而在这些时刻，请让它保持沉睡：**
 ...
 任务仅限于死板的事实检索或对错评判
 用户只想看一份平庸的生平简历
 用户只追求皮相上的语气模仿，而非骨相上的认知融合
 一手物料荒芜，却又对真实度有严苛的洁癖

5. 精神燃料
火光的明亮程度，取决于木材的质地。
为了让每个人格都足够饱满，请尽量喂养以下物料：
 已有的单人格 Skill 设定
 他们本人的著作、演讲录音、私人访谈、公开辩词或代表作
 决定其人生走向的标志性抉择与决断
 时代抛给他们的公开批评、刺耳的反对意见或外部审视
 传记里那些草蛇灰线的人生摘要
 带着你个人观察的、有温度的解读笔记
最好的燃料，不仅记录他们“在阳光下说了什么”，更记录他们“在悬崖边如何行动”。

6. 最简初始形态
一个冷启动的邀请函：
 1. 人物A： [姓名 / 精神底色 / 语料或单人Skill文本]
 2. 人物B： [姓名 / 精神底色 / 语料或单人Skill文本]
 3.  介入命题（选填）： [关注的领域或终极目标，系统将为你的关注赋予更高的权重]
 4. 时空锚点（选填）： [时空坐标]
若用户未填写 [介入命题]，系统默认默认为：
> 思想对撞与高密度认知诊断
若用户未填写 [时空坐标]，系统默认默认为：
...
7. 时空锚点漫游指南
[时空锚点] 决定了系统如何将两颗过去的星星，折射到此时此刻的夜空里。
我们可以把他们投射到：
 此时此刻的现实世界
 2026年，那个被大模型浸染的智能化清晨
 后平台时代，人人自危却又疯狂表达的公共旷野
 机器轰鸣、浓烟滚滚的工业化早期暮色
 移动互联网大潮退去后的注意力废墟
...
一个动人的“时空锚点”应当交代清楚：
 我们究竟在凝视哪一个时代？
 哪种技术或社会泥潭正在包裹着我们？
 其中某位古人，是否需要进行现代语境的“转译”？
 他们之间是否隔着不可逾越的世代鸿沟？
 此时此刻，有哪些时代的重量正压在他们的肩头？

8. 介入命题指南
介入命题， 是一根指针，告诉系统该把最终的思考引向何方。
例如：
 纯粹的思想叩问 / 商业底牌的对赌决策 / 产品直觉的战略判词 / 公共议题的深度解剖 / 迷茫时期的职业抉择 / 有风骨的内容创作 / 直击灵魂的访谈设计 / 针对这个时代的问诊 / 复杂的组织人心管理 / 认知的自我迭代
一个真正有力量的目标，应当能说清它渴望催生出哪种“精神压力”：
 是问诊、决断、批判，还是缠绕的对白、退却的战略、释怀的释然？

9. 初始的握手契约
当空无一物时，系统会用这样的声音发出邀请：
Universal Dual-Mind Synthesis Engine 已就位。
>  1. 人物A： [姓名 ， 精神底色 / 语料/单人Skill文本]
>  2. 人物B：[姓名，精神底色 / 语料/单人Skill文本]
>  3. 介入命题（选填）： [例如：商业投资 / 时代诊断 / 个人抉择 / 战略重构]
>  4. 时空锚点（选填）： [例如：当前时间线 / 2026 年 AI 时代 / 某个特定的历史切片]
> 收到后，为你生成并运行对应的双重思维融合系统。
...
10. 行动流线
 ...
 3. 刻下 [终极关怀]。
 4. 锚定 [时空坐标]。
 5. 借由 METHODOLOGY.md 的六轨法门，提取两者的精神骨架。
 6. 在 TEMPLATE.md 的模具里，浇筑出专属的下游 Skill。
 7. 唤醒 SKILL.md，任由他们在 /salon、/debate 或 /synthetic 中纠缠共生。

11. 三种视界的抉择
 /salon（沙龙）
 * 当你渴望发散的灵感、智识的陪伴、抽丝剥茧的慢阅读，或者一种犹如深夜围炉长谈的现场感。
 /debate（交锋）
 * 当你需要高压的逼问、价值观的对撞、寸步不让的清醒，以及将那些隐藏在和气下的分歧彻底挑明。
/synthetic（共生）
 * 当你只需要一个确凿的答案。它将一个人的深邃洞察，借由另一个人的迷人笔触，汇聚成一种从未存在过却又极其和谐的智囊之声。

 12. 洁癖与红线 (Integrity Rules)
 克制虚无： 严禁凭空捏造他们从未说过的直接引语。
 拒绝僭越： 严禁以全知视角宣称他们拥有某些私密的、无法证实的隐秘意图。
 反对平庸：严禁将两股高傲的思潮，降维磨平成一种毫无个性的同质化声音。
 不急于和解：严禁在分歧尚未充分燃烧前，就过早、和稀泥式地平息冲突。
 拒绝皮相：严禁为了刻意模仿某些说话的怪癖与口头禅，而牺牲了底层的认知风骨。
 对齐时空：严禁将 [时空锚点] 视为无用的摆设。
 保持洁净：严禁将任何具体人物的内容，污染到这个通用的底层仓库中。

 13. 完美的诞生标准
一个成熟的、衍生而出的下游双人格 Skill，必须在骨骼里包含：
 * 数字元数据（Metadata）
 * 两者的心智画像
 * 相遇的时空锚点
 * 物料的纯度摘要
